...
def create_modules(blocks):
    """
    Create the necessary PyTorch modules from a given configuration files blocks.
    """
    ...
    for index, x in enumerate(blocks[1:]):
        ...
        # If it is a route layer
            ...
            # Create an empty layer to avoid unnecessary abstractation
            # this empty layer will be skipped in forward pass
            route = EmptyLayer()
...
class Darknet(nn.Module):
    ...
    def forward(self, input: torch.Tensor, CUDA=True):
        ...
        for i, module in enumerate(modules):
            ...
            if module_type == "convolutional" or module_type == "upsample":
                ...
                input = outputs[i-1] + outputs[i+from_]
                outputs[i] = input
                ...
                # Transform
                input = input.data
                input = predict_transform(
                    input, inp_dim, anchors, num_classes, CUDA)
    ...
    def load_weights(self, w_file):
        with open(w_file, "rb") as file:
            ...
            for i in range(len(self.module_list)):
                ...
                # Skip modules other than convolutional
